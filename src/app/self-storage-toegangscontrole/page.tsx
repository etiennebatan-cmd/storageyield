      ...
      <main className="bg-[#f6f7f9]">
        ...
        <LifecycleFlow
          ...
          steps={[
            ...
            { title: "Suspend/revoke", copy: "Non-payment suspension en move-out revocation als lifecycle.", status: "Roadmap" }
          ]}
        />
        <section className="mx-auto grid max-w-[1240px] gap-6 px-5 py-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">Toegang moet de lifecycle volgen, niet andersom</h2>
